...
本主题的 golden source 是 `assets/template-swiss.html` 及 `swiss-layout-lock.md` 登记的 22 个版式。生成时以这两份文件为准。
...
1. 同时打开两份页面:当前 `assets/template-swiss.html`(模板基线)、正在生成或修改的测试 PPT。如果手头有历史版本的瑞士风 deck 也可以一起开作横向对照。
